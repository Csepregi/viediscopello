    ...
    return (
        ...
        <div>
          ...
          <button onClick={toggleMenu} className="text-blue hover:text-gray-700 lg:hidden">
            ...
            <a href="/wineTasting" className="text-xl font-semibold text-blue hover:text-blue-800">Tastavino</a>
          </div>
       ...
       <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
         <a href="/wineTasting" className="block px-3 py-2 rounded-md text-base font-medium text-blue hover:text-blue-800 hover:bg-gray-50">Tastavino</a>
       </div>
     </div>
        )}
      </header>
